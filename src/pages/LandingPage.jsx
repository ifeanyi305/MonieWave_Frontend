    ...
    <div className="containers">
      <div className={style.flex}>
        <div className="border-[#814DE5] h-[316px] rounded-[11px] border-[1px] px-2 py-4">
          ...
          <div className="flex justify-center mt-[29%]"><button type="button" className="p-2 login_btn bg-[#814DE5] text-[#fff] w-[160px] text-center">Send money</button></div>
        </div>
        <div className="px-4">
      ...
      <div className="flex mt-[15%] px-[5%] justify-between items-start">
        <div>
          ...
          <div className="mt-[10%]"><button type="button" className="p-2 login_btn bg-[#814DE5] text-[#fff] w-[160px] text-center">Get started</button></div>
        </div>
        <div>
      ...
      <div className="bg-[#212121] mt-[10%]">
        <div className="px-[5%]">
          ...
          <div className="flex justify-center mt-[4%] pb-[9%]"><button type="button" className="p-2 login_btn bg-[#814DE5] text-[#fff] w-[160px] text-center">Send money</button></div>
        </div>
      </div>
      <div className="flex mt-[15%] px-[5%] justify-between items-start">
        <div>
          ...
          <div className="mt-[10%]"><button type="button" className="p-2 login_btn bg-[#814DE5] text-[#fff] w-[160px] text-center">Open Account</button></div>

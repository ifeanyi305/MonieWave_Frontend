    ...
    <div>
      ...
      <div className="flex justify-center px-6 mt-[10%]">
        <div>
          ...
          <h1 className="py-4 text-[24px] text-center font-extrabold">Your MonieWave account have been created successfully</h1>
          <p className="py-4 text-center">You can log back into your MonieWave account using these details</p>
